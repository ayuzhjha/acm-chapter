  ...
  return (
    ...
    >
      <div className="w-full max-w-[90rem] mx-auto flex justify-between gap-12 items-center relative">
        ...
        >
          <img src="/acmlogo.png" alt="ACM Logo" className="h-14 md:h-20 w-auto object-contain" />
        </a>

        {/* MIDDLE LINKS */}
        <div className=" hidden lg:flex py-4 px-10 bg-white/50 border border-white/20 backdrop-blur-lg rounded-4xl relative overflow-clip gap-6 -left-10 mb-2 items-center">
        ...
        <button
          ...
          className="rounded-full bg-white/50 border border-white/20 backdrop-blur-lg cursor-pointer p-2.5 md:p-3.5 relative  flex items-center justify-center mb-2"
        >
          <Menu className="" />
        </button>
      </div>
