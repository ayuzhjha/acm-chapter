...
const Images = ({ imgIndex }) => {
  return (
    <>
      {PreviousEventsDataMobile.map((imgSrc, idx) => {
        return (
          <div key={idx} className="w-screen shrink-0 flex justify-center items-center">
            <motion.div
              style={{
              ...
              transition={SPRING_OPTIONS}
              className="aspect-[1/1.414] w-[90vw] shrink-0 rounded-xl bg-neutral-800 object-cover"
            />
          </div>
        );
      })}
